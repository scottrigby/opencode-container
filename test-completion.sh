...
run_zsh_test "no subcommand: shows --feature-file" "--feature-file" opencode-container ""
...
run_bash_test "no subcommand: shows --feature-file" "--feature-file" opencode-container ""
